...
export declare type InjectType = 'script' | 'style';
/** Where to insert the external */
export declare type ExternalPosition = 
/** Insert before generated entries. */
'before'
/** Insert after generated entries. */
 | 'after';
export declare type PreloadChunkTypeRecord = Record<string, {
    rel: 'module' | 'preload' | 'modulepreload';
    type: InjectType;
}>;
export declare type PreloadChunkTypeArray = {
    name: string;
    rel: 'module' | 'preload' | 'modulepreload';
    type: InjectType;
}[];
export declare type PreloadChunk = PreloadChunkTypeArray | PreloadChunkTypeRecord;
/**
 ...
 */
export declare type Crossorigin = 
